...
define('bead/tests/pods/components/new-dog-form.1/component.jshint', function () {

  'use strict';

  QUnit.module('JSHint - pods/components/new-dog-form.1');
  QUnit.test('pods/components/new-dog-form.1/component.js should pass jshint', function(assert) { 
    assert.ok(false, 'pods/components/new-dog-form.1/component.js should pass jshint.\npods/components/new-dog-form.1/component.js: line 1, col 1, \'import\' is only available in ES6 (use esnext option).\npods/components/new-dog-form.1/component.js: line 3, col 1, \'export\' is only available in ES6 (use esnext option).\npods/components/new-dog-form.1/component.js: line 7, col 9, \'concise methods\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\npods/components/new-dog-form.1/component.js: line 23, col 5, \'concise methods\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\n\n4 errors'); 
  });
...
define('bead/tests/pods/dog/dogs/list/route.jshint', function () {

  'use strict';

  QUnit.module('JSHint - pods/dog/dogs/list');
  QUnit.test('pods/dog/dogs/list/route.js should pass jshint', function(assert) { 
    assert.ok(false, 'pods/dog/dogs/list/route.js should pass jshint.\npods/dog/dogs/list/route.js: line 1, col 1, \'import\' is only available in ES6 (use esnext option).\npods/dog/dogs/list/route.js: line 3, col 1, \'export\' is only available in ES6 (use esnext option).\npods/dog/dogs/list/route.js: line 4, col 5, \'concise methods\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\n\n3 errors'); 
  });

});
define('bead/tests/pods/dog/dogs/new/controller.jshint', function () {

  'use strict';

  QUnit.module('JSHint - pods/dog/dogs/new');
  QUnit.test('pods/dog/dogs/new/controller.js should pass jshint', function(assert) { 
    assert.ok(false, 'pods/dog/dogs/new/controller.js should pass jshint.\npods/dog/dogs/new/controller.js: line 1, col 1, \'import\' is only available in ES6 (use esnext option).\npods/dog/dogs/new/controller.js: line 3, col 1, \'export\' is only available in ES6 (use esnext option).\npods/dog/dogs/new/controller.js: line 5, col 9, \'concise methods\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\n\n3 errors'); 
  });

});
define('bead/tests/pods/dog/dogs/new/route.jshint', function () {

  'use strict';

  QUnit.module('JSHint - pods/dog/dogs/new');
  QUnit.test('pods/dog/dogs/new/route.js should pass jshint', function(assert) { 
    assert.ok(false, 'pods/dog/dogs/new/route.js should pass jshint.\npods/dog/dogs/new/route.js: line 1, col 1, \'import\' is only available in ES6 (use esnext option).\npods/dog/dogs/new/route.js: line 3, col 1, \'export\' is only available in ES6 (use esnext option).\n\n2 errors'); 
  });
...
define('bead/tests/pods/user/model.jshint', function () {
  ...
  QUnit.test('pods/user/model.js should pass jshint', function(assert) { 
    assert.ok(false, 'pods/user/model.js should pass jshint.\npods/user/model.js: line 1, col 1, \'import\' is only available in ES6 (use esnext option).\npods/user/model.js: line 3, col 1, \'export\' is only available in ES6 (use esnext option).\n\n2 errors'); 
  });
